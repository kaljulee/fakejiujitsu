import{S as h,i as g,s as d,y as r,z as s,A as l,g as p,d as c,B as u,F as f}from"../chunks/index.2c6af615.js";import{P as m}from"../chunks/PageWrapper.b9d93ea4.js";import{C as y}from"../chunks/ConcernPage.f9c39476.js";const b=""+new URL("../assets/pattern.aba9f657.gif",import.meta.url).href;function T(n){let t,i;return t=new y({props:{title:"Pattern and Timing",source:n[0],headerImg:b}}),{c(){r(t.$$.fragment)},l(e){s(t.$$.fragment,e)},m(e,a){l(t,e,a),i=!0},p:f,i(e){i||(p(t.$$.fragment,e),i=!0)},o(e){c(t.$$.fragment,e),i=!1},d(e){u(t,e)}}}function w(n){let t,i;return t=new m({props:{$$slots:{default:[T]},$$scope:{ctx:n}}}),{c(){r(t.$$.fragment)},l(e){s(t.$$.fragment,e)},m(e,a){l(t,e,a),i=!0},p(e,[a]){const o={};a&2&&(o.$$scope={dirty:a,ctx:e}),t.$set(o)},i(e){i||(p(t.$$.fragment,e),i=!0)},o(e){c(t.$$.fragment,e),i=!1},d(e){u(t,e)}}}function v(n){return[`
## Summary
...
The ability to repeat patterns in live movement gives repeated opportunities to look for the weight shifts and develop [affordances](https://youtu.be/RXT5UKKSWzs) around them.
...
[Here is video evidence of a JJB](https://youtu.be/DzuGUsMEpFQ).
...
Once cooperative movement is relatively easy, the Tori [syncopates](https://youtu.be/NQPcup4sbAE) against the pattern, looking for ways to do so that destabilize the Uke.  The Tori is still telegraphing his motions, but is occasionally telegraphing lies.
...
`]}class P extends h{constructor(t){super(),g(this,t,v,w,d,{})}}export{P as component};
