import{S as d,i as m,s as h,y as r,z as s,A as p,g as u,d as c,B as l,F as f}from"../chunks/index.30d36c53.js";import{P as g}from"../chunks/PageWrapper.1f9b0c22.js";import{C as y}from"../chunks/ConcernPage.ea4e257f.js";const b=""+new URL("../assets/turtleMapExample.6a8ade07.png",import.meta.url).href;function J(i){let n,o;return n=new y({props:{source:i[0],headerImg:b,title:"Origin Point"}}),{c(){r(n.$$.fragment)},l(e){s(n.$$.fragment,e)},m(e,t){p(n,e,t),o=!0},p:f,i(e){o||(u(n.$$.fragment,e),o=!0)},o(e){c(n.$$.fragment,e),o=!1},d(e){l(n,e)}}}function v(i){let n,o;return n=new g({props:{$$slots:{default:[J]},$$scope:{ctx:i}}}),{c(){r(n.$$.fragment)},l(e){s(n.$$.fragment,e)},m(e,t){p(n,e,t),o=!0},p(e,[t]){const a={};t&2&&(a.$$scope={dirty:t,ctx:e}),n.$set(a)},i(e){o||(u(n.$$.fragment,e),o=!0)},o(e){c(n.$$.fragment,e),o=!1},d(e){l(n,e)}}}function T(i){return[`
<style>
table {
...
Smaller, relatively simple points should allow a higher resolution when talking about grappling positions and movements.
...
Moving further away from the Origin means more reaching, posting, and framing.  This will create more complex grappling configurations, eventually the equivalent of a BJJ Top Game.
...
You must defend your zero point positioning and maneuver your opponent into being out of position.  This is true on bottom and on top, so defense *and* offense need to be played in *all* BJJ positions.

`]}class P extends d{constructor(n){super(),m(this,n,T,v,h,{})}}export{P as component};
